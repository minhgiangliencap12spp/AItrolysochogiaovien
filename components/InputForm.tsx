...
import { GRADES, QUESTION_TYPES, DIFFICULTIES, QUESTION_COUNTS, SUBJECTS, LIT_PAGE_COUNTS } from '../constants';
    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {isLiterature || isEssayType ? (
          /* Literature/Essay Logic: Show Page Count, Hide Difficulty/Question Count (often implied) */
          <>
             <div className="space-y-2">
             ...
             {/* Hidden Difficulty/Count for pure Essay mode to simplify, or keep them if needed. 
                 Since Essay is usually 1 question, we can hide Question Count or disable it. */}
          </>
        ) : (
          /* Standard Logic */
          <>
